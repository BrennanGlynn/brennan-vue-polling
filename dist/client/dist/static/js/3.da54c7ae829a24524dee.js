...
webpackJsonp([3], { 332: function _(e, t, o) {
    o(392);var n = o(21)(o(364), o(409), "data-v-9f6ab332", null);e.exports = n.exports;
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var n = o(29),
      ...
      return e && e.__esModule ? e : { default: e };
        ...
        l = o(41);t.default = { computed: (0, s.default)({}, (0, l.mapGetters)(["username", "userRole"])), data: function data() {
        return { hasVoted: !1 };
    ...
    function n(e) {
      return e && e.__esModule ? e : { default: e };
        ...
        return { formVisible: !1, form: { name: "", options: [{ option: "", votes: [] }, { option: "", votes: [] }] }, rules: { name: [{ required: !0, message: this.$t("polls.rules.name"), trigger: "blur" }], options: [{ type: "array", required: !0, message: this.$t("polls.rules.options"), trigger: "change" }] }, polls: [] };
      }, computed: (0, a.default)({}, (0, c.mapGetters)(["username", "userRoll", "loggedIn"])), methods: { fetch: function fetch() {
          var e = this;i.poll.query().then(function (e) {
            return e.json();
          }).then(function (t) {
            e.polls = t.results;
          }).catch(function (e) {
          ...
          var t = this;this.$confirm("This action will remove the selected poll: " + e.name + " Do you still want to continue?", this.$t("confirm.title"), { type: "warning" }).then(function () {
            i.poll.delete({ _id: e._id }).then(function () {
          ...
          var e = this;this.$refs.poll.validate(function (t) {
            if (t) {
              var o = void 0;o = e.form._id ? i.poll.update({ _id: e.form._id }, e.form) : i.poll.save({}, { name: e.form.name, author: e.username, options: e.form.options }), o.then(function () {
                e.cancelForm(), e.$message({ type: "success", message: e.form._id ? e.$t("message.updated") : e.$t("message.created") }), e.fetch();
              }).catch(function () {});
            }
          });
        } }, components: { PollResults: f.default }, created: function created() {
        this.fetch();
      } };
  }, 382: function _(e, t, o) {
    t = e.exports = o(329)(!0), t.push([e.i, ".head[data-v-9f6ab332]{background-color:#20a0ff;border:1px solid #d1dbe5;border-radius:4px;color:#fff;font-size:40px;text-align:center;padding:10px}", "", { version: 3, sources: ["C:/Users/brenn/WebstormProjects/brennan-vue/client/src/view/Dashboard.vue"], names: [], mappings: "AACA,uBACE,yBAA0B,AAC1B,yBAA0B,AAC1B,kBAAmB,AACnB,WAAY,AACZ,eAAgB,AAChB,kBAAmB,AACnB,YAAmB,CACpB", file: "Dashboard.vue", sourcesContent: ["\n.head[data-v-9f6ab332] {\n  background-color: #20a0ff;\n  border: 1px solid #d1dbe5;\n  border-radius: 4px;\n  color: #fff;\n  font-size: 40px;\n  text-align: center;\n  padding: 10px 10px;\n}"], sourceRoot: "" }]);
  }, 392: function _(e, t, o) {
    var n = o(382);"string" == typeof n && (n = [[e.i, n, ""]]), n.locals && (e.exports = n.locals);o(330)("4ac9cd03", n, !0);
  }, 409: function _(e, t) {
    e.exports = { render: function render() {
        var e = this,
            t = e.$createElement,
            o = e._self._c || t;return o("content-module", { attrs: { name: "dashboard" } }, [o("div", { staticClass: "head" }, [o("el-row", [o("el-col", { attrs: { span: 24 } }, [e._v("\n        Brennan Polling\n      ")])], 1), e._v(" "), o("el-row", [o("el-col", { attrs: { span: 8, offset: 8 } }, [o("el-button", { attrs: { size: "small", type: "warning" }, on: { click: function click(t) {
              e.$router.push("/me");
            } } }, [e._v("My Polls")]), e._v(" "), e.loggedIn ? o("el-button", { attrs: { size: "small", icon: "plus", type: "success" }, on: { click: e.createPoll } }, [e._v("Create a Poll!")]) : o("el-button", { attrs: { size: "small", type: "success" }, on: { click: function click(t) {
              e.$router.push("/login");
            } } }, [e._v("Login")])], 1)], 1)], 1), e._v(" "), o("div", e._l(this.polls, function (t, n) {
...
//# sourceMappingURL=3.da54c7ae829a24524dee.js.map